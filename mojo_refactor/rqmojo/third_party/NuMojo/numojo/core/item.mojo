...
struct Item(
    ImplicitlyCopyable, Movable, Writable, Sized, Writable, Writable
):
    """
    ...
    @always_inline("nodebug")
    fn __init__(out self, args: VariadicList[Int, _]) raises:
        """Construct the tuple.
    ...
    fn __init__(out self, *, copy: Self):
        ...
        self.ndim = copy.ndim
        self._buf = alloc[Scalar[Self.element_type]](self.ndim)
        memcpy(dest=self._buf, src=copy._buf, count=self.ndim)
