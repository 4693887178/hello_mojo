...
struct DataProxy(Movable):
    ...
    fn get_trading_minutes_for(self, instrument: Instrument, trading_dt: DateTime) -> List[DateTime]:
        ...
        if instrument.type == INSTRUMENT_TYPE.CS() or instrument.type == INSTRUMENT_TYPE.ETF() or instrument.type == INSTRUMENT_TYPE.LOF():
    ...
    fn _get_instrument_by_id(self, order_book_id: String) -> Instrument:
        if order_book_id == "RB1912":
            return create_future_instrument("RB1912", "螺纹钢1912", DateTime(2019, 1, 1, 0, 0, 0, 0), DateTime(2019, 12, 15, 0, 0, 0, 0), DateTime(2019, 12, 15, 0, 0, 0, 0), 10.0, EXCHANGE.SHFE(), "RB")
        elif order_book_id == "AG1912":
            return create_future_instrument("AG1912", "白银1912", DateTime(2019, 1, 1, 0, 0, 0, 0), DateTime(2019, 12, 15, 0, 0, 0, 0), DateTime(2019, 12, 15, 0, 0, 0, 0), 15.0, EXCHANGE.SHFE(), "AG")
        elif order_book_id == "TF1912":
            return create_future_instrument("TF1912", "五年期国债1912", DateTime(2019, 1, 1, 0, 0, 0, 0), DateTime(2019, 12, 15, 0, 0, 0, 0), DateTime(2019, 12, 15, 0, 0, 0, 0), 10000.0, EXCHANGE.CFFEX(), "TF")
