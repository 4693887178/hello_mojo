...
def py_bool_to_bool(obj: PythonObject) raises -> Bool:
...
def compile_strategy_safe(source_code: String, strategy: String, scope: PythonObject) raises -> PythonObject:
    var builtins = Python.import_module("builtins")
...
def load_strategy_from_file(file_path: String) raises -> PythonObject:
    var builtins = Python.import_module("builtins")
...
def load_strategy_from_code(code: String, strategy_name: String) raises -> PythonObject:
    var builtins = Python.import_module("builtins")
...
def validate_strategy_functions(scope: PythonObject) raises -> Bool:
...
def extract_strategy_functions(scope: PythonObject) raises -> PythonObject:
