...
def create_stock_decider(commission_multiplier: Float64 = 0.0003, min_commission: Float64 = 5.0, stamp_tax_rate: Float64 = 0.001, transfer_fee_rate: Float64 = 0.00002) -> StockTransactionCostDecider:
...
def create_future_decider(commission_multiplier: Float64 = 0.0001, close_commission_multiplier: Float64 = 0.0001) -> FutureTransactionCostDecider:
...
def create_bond_decider(commission_multiplier: Float64 = 0.0001) -> BondTransactionCostDecider:
