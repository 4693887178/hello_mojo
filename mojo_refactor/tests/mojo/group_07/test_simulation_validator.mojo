...
from rqmojo.mod.rqmojo_mod_sys_simulation.validator import (
    OrderStyleValidator, create_order_style_validator
)
...
def test_order_style_validator_init() -> Bool:
...
def test_order_style_validator_validate_order() -> Bool:
...
def test_order_style_validator_can_submit() -> Bool:
...
def test_order_style_validator_can_cancel() -> Bool:
...
def test_order_style_validator_validate_submission() -> Bool:
...
def test_order_style_validator_validate_cancellation() -> Bool:
