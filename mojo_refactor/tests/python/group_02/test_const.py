"""
Test for rqalpha/const.py
Group 02 - File 1
Tests all enum classes and constants
"""
import pytest
from rqalpha.const import (
    ...
    TRADING_CALENDAR_TYPE, MARKET, CustomEnum, CustomEnumMeta
)
...
class TestCustomEnumMeta:
    def test_contains_by_name(self):
        ...
        assert 'BACKTEST' in RUN_TYPE
        assert 'STOCK' in DEFAULT_ACCOUNT_TYPE
